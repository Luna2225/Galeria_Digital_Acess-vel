    ...
    <div class="">
      <?php if ($seguranca) { ?>
        ...
        <form action="" class="contact__form" method="post" enctype="multipart/form-data">
          ...
          <input value="<?php echo $_GET['autor']; ?>" type="text" placeholder="Autor" autocomplete="name"
            class="contact__input" name="autor">
          <input value="<?php echo $_GET['nome_obra']; ?>" type="text" placeholder="Nome da obra" class="contact__input"
            name="nome_obra">
          ...
          <p>
            ...
            <input value="<?php echo $_GET['audiodescricao']; ?>" type="file" class="input1 contact__input"
              id="inputGroupFile02" name="audiodescricao">
          </p>

          <b><label>Descrição da obra</label></b>
          <textarea name="Descricao" id="" cols="0" rows="10" class="contact__input"
            placeholder="Descreva aqui"><?php echo $_GET['Descricao']; ?></textarea>

          <b><label>Descreva a imagem da obra</label></b><br>
          <textarea name="LongaDesc" id="" cols="0" rows="10" class="contact__input"
            placeholder="Descreva aqui"><?php echo $_GET['LongaDesc']; ?></textarea>
