    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link" aria-current="page" href="/index.php" aria-label="Página inicial">HOME</a>
        ...
        <div class="col-md-8">
          <div class="card-body">
            <h3>
              ...
              forma que possam ter uma experiência
              mais proveitosa na internet.
            </h3>
          </div>
        </div>
        <div class="col-md-4">
