...
<body>
    ...
    <nav class="navbar" id="menu">
        <div class="container-fluid">
            <a class="navbar-brand" href="javascript:history.back()" id="logo"><i class="fa-solid fa-arrow-left"></i>
                ARCEBLE</a>
        </div>
    </nav>
    ...
    <center>
        <div class="container-fluid" id="container">
            <?php if ($exposicao) { ?>
                <img src="<?php echo $exposicao['Imagem']; ?>" class="img-fluid obra"
                    alt="<?php echo $exposicao['Desc_Imagem']; ?>"><br>
                <audio controls autoplay>
                    <source src="<?php echo $exposicao['Audio_expo']; ?>" type="audio/mpeg">
                    <track kind="captions" src="<?php echo $exposicao['Desc_expo']; ?>" srclang="pt-BR" label="Português"
                        default>
                </audio>
                            ...
                            <div class="modal-body">
                                <a href="whatsapp://send?text=Nome da obra:%0ahttps://br.freepik.com/fotos/flores"
                                    style="color: darkgreen;"><i
                                        class="fa-brands fa-whatsapp fa-3x"></i><br>whatsapp</a><br>
                                <a href="" style="color: blue;"><i
                                        class="fa-brands fa-facebook fa-3x"></i><br>Facebook</a><br>
                                <a href="" style="color: rgb(129, 39, 151);"><i
                                        class="fa-brands fa-instagram fa-3x"></i><br>Instagram</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <?php else: ?>
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <?php foreach ($obrasExposicao as $obraExposicao) { ?>
                                <div class="col">
                                    <div class="card img">
                                        <img src="<?php echo $obraExposicao['imagem']; ?>" class="card-img-top"
                                            alt="<?php echo $obraExposicao['LongaDesc']; ?>">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                            ...
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                <a href="descricao_obra.php?id_Obras=<?php echo $obraExposicao['id_Obras']; ?>&origem=descricao_evento"
