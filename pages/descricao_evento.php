...
<body>
    ...
    <nav class="navbar" id="menu">
        <div class="container-fluid">
            <a class="navbar-brand" href="eventos.html" id="logo"><i class="fa-solid fa-arrow-left"></i> ARCEBLE</a>
        </div>
    </nav>
    ...
    <center>
        <div class="container-fluid" id="container">
            ...
            <img src="assets/img/05.jpg" class="img-fluid img_even" alt="..."><br>
            <audio controls autoplay>
                <source src="assets/audio/Audiodescrição obra A Noite Estrelada de Vincent Van Gogh.mp3"
                    type="audio/mpeg">
            </audio>
