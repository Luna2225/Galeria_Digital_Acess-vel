  ...
  <center>
    <div class="container-fluid">
      <form action="" class="contact__form" method="post">
        ...
        <input type="date" placeholder="Data de Nascimento" autocomplete="number" class="contact__input"
          name="data_nasc" aria-label="Digite a sua data de nascimento">
        ...
        <input type="password" placeholder="Confirmar Senha" name="repetesenha" class="contact__input"
          aria-label="Digite novamente a sua senha">
